...
|  image                                           | src                                                  |
|:-------------------------------------------------|:-----------------------------------------------------|
| ![avatar example](https://raw.githubusercontent.com/maxlath/wikidata-hub/master/assets/images/esa.jpeg)        | [/Q42262?p=avatar&w=128](https://tools.wmflabs.org/hub/Q42262?p=avatar&w=128)                             |
| ![image example](https://raw.githubusercontent.com/maxlath/wikidata-hub/master/assets/images/laniakea.jpg)     | [/frwiki:Laniakea?p=image&w=256](https://tools.wmflabs.org/hub/frwiki:Laniakea?p=image&w=256)                     |
...
|  **request**                                    | **redirection**                                                                                   |
|-------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [/Q184226?s=wq,wp,wd&l=fr,en,de](https://tools.wmflabs.org/hub/Q184226?s=wq,wp,wd&l=fr,en,de)                | https://fr.wikiquote.org/wiki/Gilles_Deleuze                                                      |
